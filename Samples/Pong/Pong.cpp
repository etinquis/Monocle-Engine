...
{    
	...
	*/
	...
	void GameScene::Begin()
	{
		...
		Gwen::Skin::Simple skin = Gwen::Skin::Simple();

		skin.SetRender(new GUI::GwenRenderer());
		GUI::GwenPanel *pnl = new GUI::GwenPanel(&skin);
		
		Gwen::Controls::Label *lbl = new Gwen::Controls::Label(pnl);
		lbl->SetText("Test");
		lbl->SetBounds(50,50, 100,100);
