...
//	}
//
//	Level::Level(FileNode *myNode) 
//		: Serializable(myNode), scene(NULL), fringeTileset(NULL)
//	{
//		instance = this;
//	}
//
...
//	//}
//
//	void Level::LoadFrom(FileNode *myNode)
//	{
//		std::string levelfile;
//		myNode->Read("file", levelfile);
//
//		if(!levelfile.empty())
//		{
//			File<FileType::XML> file(levelfile);
//			file.Load();
//			myNode = file.GetRootNode()->GetChild("Level");
//		}
//
//		if(!myNode)
//		{
...
//
//		std::string fringeTilesetName;
//		myNode->Read("fringeTileset", fringeTilesetName);
//
//		if(fringeTilesetName != "")
//		{
//			fringeTileset = instance->GetFringeTilesetByName(fringeTilesetName);
//		}
//
//		std::list<FileNode *> tmlist = myNode->GetChildren("Tilemap");
//		for(std::list<FileNode *>::iterator it = tmlist.begin(); it != tmlist.end(); it++)
//		{			
//			Tilemap *tilemap = new Tilemap(*it);
//			tilemaps.push_back(tilemap);
//			//scene->Create<Entity>()->SetGraphic(tilemap);
//		}
//	}
//
...
//	}
//
//	void Level::SaveTo(FileNode *parentNode)
//	{
//		FileNode *myNode = parentNode->InsertEndChildNode("Level");
//		myNode->Write("width", width);
//		myNode->Write("height", height);
//
//		if(fringeTileset)
//		{
//			myNode->Write("fringeTileset", fringeTileset->GetName());
//		}
//	}
//
//	//void Level::Save()
