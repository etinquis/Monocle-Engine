...
//				moveStartPosition = Input::GetWorldMousePosition();
//				moveStartMagnitude = (Input::GetWorldMousePosition() - ((Transform*)(*selectedEntity)["Transform"])->position).GetMagnitude();
...
//				moveStartPosition = ((Transform*)(*selectedEntity)["Transform"])->position;
//				moveOffset = ((Transform*)(*selectedEntity)["Transform"])->position - Input::GetWorldMousePosition();
//				moveAxisLock = 0;
//				SetState(FTES_MOVE);
//				return;
//			}
...
//		}
//
//		Vector2 diff = (Input::GetWorldMousePosition() - ((Transform*)(*selectedEntity)["Transform"])->position);
